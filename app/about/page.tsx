...
export default function About() {
  return (
      <div className="space-y-12 text-md md:text-lg text-muted-foreground pb-4 md:pb-8">
          <p>
              Introducing Cloud Convert, the ultimate multimedia conversion powerhouse that empowers you to transform images,
          ...
          <div className="space-y-2">
              <h2 className="text-xl md:text-2xl font-medium text-muted-foreground">Image Conversion:</h2>
              <p>
